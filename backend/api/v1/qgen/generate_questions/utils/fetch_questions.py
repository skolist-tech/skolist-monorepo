...
async def fetch_questions_from_bank(
    ...
    async def run_query(target_diff: str | None = None):
        ...
        # 2. Fetch questions
        # Bolt: Explicitly specify required columns instead of "*" to reduce DB load and network payload
        columns = (
            ...
            "match_columns, svgs, is_solved_example, is_from_exercise, "
            "bank_questions_concepts_maps(concept_id)"
        )
