...
| --- | --- |
| `auth.spec.ts` | Guest sees email, password, and organisation-code sign-in. The worker's e2e teacher lands on the test list. The worker's e2e student lands on assigned tests. |
